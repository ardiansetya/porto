...
const featuredProjects = [
  {
    ...
    description:
      'Real-time fleet management and tracking solution with GPS integration and driver analytics.',
  ...
  },
  {
    ...
    description:
      'Community-driven platform for reporting and managing natural disaster incidents in real-time.',
  ...
  },
  {
    ...
    description:
      'AI-powered early diabetes detection application using machine learning algorithms.',
